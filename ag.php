...
echo "\n";
echo "\n";
echo "| Script simple Alfagift\n";
echo "| Wani Perih \n";
echo "| Wa 085892520206 \n";
echo "| --------------------------- \n";
...
$random_name = "Andy"." ".substr(str_shuffle("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 3);
...
$data_create = '{"address":"","birthDate":"1991-10-11","debug":false,"deviceId":'.$deviceid2.',"email":'.$random_email.',"firstName":"","fullName":'.$random_name.',"gender":"F","lastName":"","latitude":0,"longitude":0,"maritalStatus":"M","password":"indah1933","phone":'.$nomorhp.',"postCode":"","registerPonta":true,"token":'.$token2.'}';
